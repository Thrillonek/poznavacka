...
export default function List() {
	...
	return (
		<div className='relative flex flex-col bg-gray-700 h-full overflow-hidden'>
			<div id='enlarged-img' className={'top-0 translate-y-full left-0 z-40 absolute flex flex-col transition-transform justify-center items-center bg-gray-700 p-3 w-screen h-full overscroll-y-none ' + (chosenFile && '!translate-y-0')}>
